...
%{
#include "stype-object-properties2.hh"
#include "lexer-object-properties2.hh"
#include "Bar.hh"
#include <string>
...
object_item_0:
    ...
    | TOKEN_2 QUOTED_STRING COLON QUOTED_STRING
        {
            $$.set_string($2, $4);
        }
    ...
    | TOKEN_2 QUOTED_STRING COLON boolean
        {
            $$.set_boolean($2, $4);
        }
    | TOKEN_2 QUOTED_STRING COLON array
        {
            $$ = $4;
            $$.set_key($2);
        }
    | TOKEN_2 QUOTED_STRING COLON object
        {
            $$ = $4;
            $$.set_key($2);
        }
    | TOKEN_2 QUOTED_STRING COLON NULL_TOKEN
        {
            $$.set_null($2);
        }
    ;
