...
#include "parser-integer-enum.hh"
#include <iostream>
...
static bool foo_foo_value_meets_constraints_0(yyscan_t yyscanner, long value)
{
	    ...
	    if (!(value == 5.000000 || value == 7.000000 || value == 10.000000))
	            {
	                std::cerr << "validation error: " << yytext << " is not one of 5.000000, 7.000000, 10.000000" << std::endl;
	                return false;
	            }
